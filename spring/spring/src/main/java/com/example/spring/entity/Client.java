...
public class Client implements Subject {
    ...
    /**
     * The trainer associated with the client.
    ...
    /**
     * Notifies the attached staff with a message.
     *
     * @param staff The staff to notify.
     * @param s     The message to notify with.
     */
    @Override
    public void notify_Staff(Staff staff, String s) {
        if (staff != null) {
            staff.update(s);
        }
    }
